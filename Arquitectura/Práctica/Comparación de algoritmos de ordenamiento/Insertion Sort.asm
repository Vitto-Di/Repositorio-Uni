...
# Algoritmo en general más efectivo e inteligente en su comportamiento que el bubble sort
# Ambos tienen complejidad O(n*n) en sus peores casos
# En varios casos de prueba el insertion sort muestra un promedio de 4-6 veces más velocidad que el bubble sort
# Se tradujeron con presición los algoritmos en MIPS a C++ para efectuar las mediciones
.data
